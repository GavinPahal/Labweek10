...
const Country = ({ country }) => {
  const {
    ...
    subregion,
    continents,
    borders, // Include borders in the destructuring
  } = country;
  ...
  // Get border countries' names, if any
  const borderCountries = borders
    ? borders.map(border => countryBorders[border] || 'Unknown').join(', ') // Reference to countryBorders data
    : 'None';
