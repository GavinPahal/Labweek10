...
const Country = ({ country }) => {
  ...
  return (
    <div className="country-card">
      {/* Cards for Alpha, Top 10, and other categories */}
      <div className="category-cards">
        <div className="category-card">Alpha</div>
        <div className="category-card">Top 10</div>
        <div className="category-card">By Population</div>
        <div className="category-card">By Area</div>
        <div className="category-card">By Continent</div>
        <div className="category-card">All</div>
        <div className="category-card">By Subregion</div>
        <div className="category-card">Choose Region</div>
      </div>
